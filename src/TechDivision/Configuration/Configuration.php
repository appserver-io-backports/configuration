...
/**
 * TechDivision\Configuration\Configuration
 *
 * NOTICE OF LICENSE
 *
...
class Configuration implements ConfigurationInterface
{
     ...
     *
     * @return \TechDivision\Configuration\Interfaces\ConfigurationInterface The instance itself
     */
     ...
     *
     * @param \TechDivision\Configuration\Interfaces\ConfigurationInterface $configuration The child configuration itself
     *
     * @return \TechDivision\Configuration\Interfaces\ConfigurationInterface The configuration instance
     */
     ...
     *
     * @return \TechDivision\Configuration\Interfaces\ConfigurationInterface The initialized configuration
     ...
     * @param string $path The path of the configuration to return
     *
     * @return \TechDivision\Configuration\Interfaces\ConfigurationInterface The requested configuration
     */
     ...
     *
     * @return \TechDivision\Configuration\Interfaces\ConfigurationInterface The instance the childs has been removed
     * @see \TechDivision\Configuration\Interfaces\ConfigurationInterface::getChild($path)
     * @see \TechDivision\Configuration\Interfaces\ConfigurationInterface::getChilds($path)
     */
     ...
     *
     * @param \TechDivision\Configuration\Interfaces\ConfigurationInterface $configuration A configuration to merge
     *
     * @return \TechDivision\Configuration\Interfaces\ConfigurationInterface The instance
     */
     ...
     * @see \TechDivision\Configuration\Configuration::setSchemaFile()
     */
